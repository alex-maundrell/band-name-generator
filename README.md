This program takes 2 user inputs and combines them to create a band name. This is how it was done in the course. I am going to eventually make this have a random output...just for fun.
